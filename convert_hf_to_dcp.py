...
def convert_hf_checkpoint(
    *,
    ...
    # add two new keys: 
    # embed_vision_patch = nn.Linear(
    #         32 * 32 * 3,  # 32 * 32 * 3,
    #         4096,
    #         bias=False,
    #     )
    # diffusion_head = nn.Linear(4096, 3072, bias=False)
    ...
    diffusion_head = nn.Linear(4096, 3072, bias=False)
    final_result["embed_vision_patch.weight"] = embed_vision_patch.weight
    final_result["diffusion_head.weight"] = diffusion_head.weight
